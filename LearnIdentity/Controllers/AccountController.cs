...
namespace LearnIdentity.Controllers
{
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null && await userManager.IsEmailConfirmedAsync(user))
                {
                    ...
                    await _emailSender.SendEmailAsync(model.Email, "Reset Password",
                                        $"Please confirm your account by <a href='{HtmlEncoder.Default.Encode(passwordResetLink)}'>clicking here</a>.");
        ...
        public IActionResult GetUserData()        
        {
            ...
            var permission = _context.MenuItemPermissionMappings.Where(x => x.RoleId == userRole.RoleId);
            return this.PartialView("~/Views/Shared/AdminLTE/_MainNavigation.cshtml", permission);
        }
    }
}
